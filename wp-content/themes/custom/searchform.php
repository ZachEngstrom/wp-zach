<form role="search" method="get" id="searchform" class="searchform header-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button type="submit" id="searchsubmit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'Custom' ); ?>" class="btn btn-default"><span class="hidden" aria-hidden="true">Submit</span><i class="fa fa-search"></i></button>
</form>